# Plugin.Maui.OtpReader Template

The `Plugin.Maui.OtpReader` repository is a template repository that can be used to bootstrap your own .NET MAUI plugin project. You can use this project structure as a blueprint for your own work.
...
8. Make super sure that your package won't show up as `Plugin.Maui.OtpReader` on NuGet! If one does, you owe me a drink!
